...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_decrypt.setGeometry(QtCore.QRect(410, 360, 91, 31))
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(540, 20, 221, 31))
        ...
        self.txt_plain_text.setGeometry(QtCore.QRect(110, 90, 451, 71))
        ...
        self.txt_cipher_text.setGeometry(QtCore.QRect(110, 200, 451, 121))
        self.txt_cipher_text.setReadOnly(False)
        self.txt_cipher_text.setObjectName("txt_cipher_text")
        self.btn_verify = QtWidgets.QPushButton(self.centralwidget)
        self.btn_verify.setGeometry(QtCore.QRect(1040, 360, 91, 31))
        self.btn_verify.setObjectName("btn_verify")
        self.btn_sign = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(790, 360, 93, 28))
        self.btn_sign.setObjectName("btn_sign")
        self.txt_info = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_info.setGeometry(QtCore.QRect(730, 90, 451, 71))
        self.txt_info.setObjectName("txt_info")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(640, 200, 71, 16))
        self.label_5.setObjectName("label_5")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(630, 90, 81, 16))
        self.label_3.setObjectName("label_3")
        self.txt_sign = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(730, 200, 451, 121))
        ...
        self.btn_gen_keys.setGeometry(QtCore.QRect(580, 420, 121, 31))
        font = QtGui.QFont()
